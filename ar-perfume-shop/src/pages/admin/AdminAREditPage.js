...
export default function AdminAREditPage() {
  ...
  // ─── Main Form UI ───────────────────────────────
  return (
    <div className="min-h-screen bg-[#0c1a3a] text-white flex flex-col items-center px-6 md:px-12 lg:px-16 py-10">
      <div className="w-full max-w-2xl bg-white/10 backdrop-blur-md p-8 rounded-2xl shadow-lg border border-white/10">
        <h1 className="text-3xl font-bold text-center mb-8">
          {id ? "Edit AR Experience" : "Create AR Experience"}
        </h1>
